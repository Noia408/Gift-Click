  ...
  return (
    <html lang="pt">
      ...
      <body className="w-screen min-h-screen h-auto bg-white flex-col flex overflow-x-hidden">
        ...
        <div className={`flex flex-col gap-[2vw] w-full ${(!pathname.includes('/login') && !pathname.includes('/signup')) ? 'min-h-full max-h-[calc(100%-8vw)]' : 'min-h-screen'} overflow-y-scroll`}>
